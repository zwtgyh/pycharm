...
import os
import time
questionnumber = input('please input question number: ')
direct = input('please input direct: ')
class Pics:
    def __init__(self):
        self.header = {
        ...
        self.url = 'https://www.zhihu.com/api/v4/questions/{}/answers?include=content&limit=20&offset=0&sort_by=default'.format(questionnumber)
        self.base_dir = '{}'.format(direct)
        self.index_url = 'https://www.zhihu.com/question/{}'.format(questionnumber)
        self.page = ''
        self.makeNewSession()
